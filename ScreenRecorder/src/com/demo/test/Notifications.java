...
class Notifications extends ContextWrapper {
    ...
    public void recording(long timeMs) {
        ...
        String str = getString(R.string.recording_time, DateUtils.formatElapsedTime(timeMs / 1000));
    ...
    private Notification.Action stopAction() {
        if (mStopAction == null) {
            ...
            mStopAction = new Notification.Action(android.R.drawable.ic_media_pause, getString(R.string.keyboard_key_media_stop), pendingIntent);
        }
        return mStopAction;
    }
